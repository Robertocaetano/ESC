...
SymbolTable::SymbolTable() // todas as variáveis privadas inicializadas como "empty"
{
	class_scope_.clear();
...
void SymbolTable::startSubroutine(void) // redefine a tabela de símbolos da sub-rotina
{
	subroutine_scope_.clear();
	arg_count_ = 0;
	var_count_ = 0;
